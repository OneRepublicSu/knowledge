...
- 标签组成
  ...
  >02 无顺序   
  >
  >$\textcolor{red}{03 ul里只能包含li标签}$  
  >
  >04 li标签里可以包含任何内容

  效果:

![无序列表.png](https://s2.loli.net/2022/07/22/mRdjnU1lzvsJcEL.png)
##### 有序列表
...
![1653217256213.png](https://s2.loli.net/2022/05/26/WCoBZMLi1mvAP7w.png)
...
- 标签组成
  ...
  > 02 dd和dt标签里可以包含任何内容 
  >
  > $\textcolor{red}{03dl里只能包含dt和dd标签}$  
  >
  > $\textcolor{red}{04dt是主题,dd是对dt的描述}$
...
- 相关属性
  ...
  $\textcolor{Emerald}{实际开发时使用css进行装饰}$
...
- 表头单元格组成
  ...
  > 表头单元格-文字加粗且居中(替换td标签)

- 表格的基本结构(了解):

  thead-表格头部 tbody-表格主体 tfoot-表格底部(可以省略 )
...
- 文本框
  ...
  > 常用属性:
  >
  > placeholeder:占位符-提示用户输入内容的文本
  >
  > value属性:获取用户输入的内容,提交之后会发送给后端服务器
...
- 第二种方法
  ...
  >
  > $\textcolor{red}{图片标签也可以放在label标签里}$
